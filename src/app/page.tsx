    ...
    <div className='flex flex-col md:flex-row w-screen h-screen'>
        ...
        <div className='flex flex-col gap-6 w-full max-w-md px-4 py-8 md:py-12'>
          <div className='flex flex-col gap-6'>
            ...
            <div className='flex items-center justify-between'>
              ...
              <h2 className='flex items-center text-xl tracking-tighter text-balance'>
                <SatoshiV2Icon className='w-6 h-6' />
                <span className='font-semibold'>{formatBigNumbers(PRODUCT?.price)}</span>
      ...
      <div className='flex flex-col justify-center items-center w-full'>
        <div className='flex w-full max-w-md h-full px-4 py-8 md:py-24'>
          <CustomAccordion product={PRODUCT} />
        </div>
        <Footer />
      </div>
    </div>
